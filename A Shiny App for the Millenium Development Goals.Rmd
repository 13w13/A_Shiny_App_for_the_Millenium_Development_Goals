...
Select a subset of PlotDT with Country_Name==China as and Series_Name Agricultural machinery, tractors
```{r}
ggplot(PlotDT[`Country_Name`=="China" &`Series_Name.x`=="Agricultural machinery, tractors"],
       aes(x= Date, y = Value)) + 
   geom_line()
...
```{r}
PlotDT[`Country_Name`=="China" & `Series_Name.x`=="Agricultural machinery, tractors"]
```

Test subTopic1
```{r}
ggplot(PlotDT[`Country_Name`=="China" &`SubTopic1`=="Agricultural production"],
       aes(x= Date, y = Value)) + 
   geom_line()
```

```{r}
PlotDT[`Country_Name`=="China"&`SubTopic1`=="Agricultural production"]
```
...
#analyse discriminante des indicateurs
